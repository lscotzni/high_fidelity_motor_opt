...
C = 0.5
motor_model = motor.create_motor_model(C=C)
motor_model.add_objective('eff_mass_lin_combo')
...
sim['rpm'] = 1167.78540849 * 4.
sim['output_torque_from_rotor'] = 828.30709113 / 4
...
prob = CSDLProblem(
    problem_name='pareto_front_C={}'.format(C),
    simulator=sim,
)
